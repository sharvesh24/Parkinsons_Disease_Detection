...
class ParkinsonPredictor:
    ...
    def load_models(self):
        ...
        try:
            ...
            rf_path = os.path.join(Config.MODELS_DIR, 'parkinson_rf_model.pkl')
            ...
            pca_path = os.path.join(Config.MODELS_DIR, 'pca.pkl')
            ...
            for path in cnn_paths:
                if os.path.exists(path):
                    try:
                        models['cnn_model'] = tf.keras.models.load_model(path)
